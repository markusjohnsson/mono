    ...
    public class Driver
    {
...
#else
                    return "JSIL.CultureInfoTables.js";
#endif
                return header_name;
            }
        ...
        public void Run()
        {
            ...
            using (StreamWriter writer = new StreamWriter(HeaderFileName, false, new UTF8Encoding(false, true)))
            {
                ...
                writer.WriteLine("JSIL.Metadata = JSIL.Metadata || {};");
                writer.WriteLine("JSIL.Metadata.NumCultureEntries = " + cultures.Count + ";");
                writer.WriteLine("JSIL.Metadata.NumRegionEntries = " + regionList.Count + ";");
                writer.WriteLine("\n");
#endif
                ...
                for (int i = 0; i < count; i++)
                {
                    ...
                    builder.Append('\n');
                                ...
                                writer.WriteLine ("};\n\n");
#else
                writer.WriteLine("JSIL.Metadata.datetime_format_entries = [");
                writer.Write(builder);
                writer.WriteLine("];\n\n");
#endif
                ...
                for (int i = 0; i < count; i++)
                {
                    ...
                    builder.Append('\n');
                                ...
                                writer.WriteLine ("};\n\n");
#else
                writer.WriteLine("JSIL.Metadata.number_format_entries = [");
                writer.Write(builder);
                writer.WriteLine("];\n\n");
#endif
                ...
                writer.WriteLine ("};\n\n");
#else
                writer.WriteLine("JSIL.Metadata.culture_entries = [");
                writer.Write(builder);
                writer.WriteLine("];\n\n");
#endif
                ...
                writer.WriteLine ("};\n\n");
#else
                writer.WriteLine("JSIL.Metadata.culture_name_entries = [");
                writer.Write(builder);
                writer.WriteLine("];\n\n");
#endif
				...
				writer.WriteLine ("};\n\n");
#else
                writer.WriteLine("JSIL.Metadata.region_entries = [");
                writer.Write(builder);
                writer.WriteLine("];\n\n");
#endif
                builder = new StringBuilder();
...
#else
                writer.WriteLine("JSIL.Metadata.region_name_entries = [");
                writer.Write(builder);
                writer.WriteLine("];\n\n");

                writer.Write("JSIL.Metadata.locale_strings = [");
                writer.Write(Entry.GetStrings());
                writer.WriteLine("];\n\n");
#endif
            }
