...
Number.prototype.GetHashCode = function () {
    return Math.floor(Math.abs(this.valueOf()));
};

Number.prototype.Object_Equals = function (y) {
    return this.valueOf() === y;
};

Number.prototype.ToInt64 = function (y) {
    return System.Int64.FromNumber(y);
}
...
JSIL.ImplementExternals(
  "System.CurrentSystemTimeZone", function ($) {

      $.Method({ Static: true, Public: true }, "GetTimeZoneData",
        ...
        function (year, data, names) {
          ...
          var minutesToTicks = tInt64.FromNumber(-10000 * 1000 * 60);

          data.value = [
                new System.DateTime(year, dstStart.getMonth(), dstStart.getDay()).get_Ticks(),
                new System.DateTime(year, dstEnd.getMonth(), dstEnd.getDay()).get_Ticks(),
                tInt64.op_Multiplication(minutesToTicks, tInt64.FromNumber(firstDay.getTimezoneOffset())),
                tInt64.op_Multiplication(minutesToTicks, tInt64.FromNumber(dstStart.getTimezoneOffset()))
            ];
...
//    this.dateData = $jsilcore.System.Int64.op_Multiplication(
//      $jsilcore.System.Int64.FromInt32(msSince1970), 
//      $jsilcore.System.Int64.FromInt32(10000)
//    );
//  });
...
//      // FIXME
//      this.dateData = dateData.ToInt64();
//    }
//  );
